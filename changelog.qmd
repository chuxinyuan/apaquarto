...
# Version 5.0.18
- 2026-03-25
- Multiple pull requests from [Michael Zehetleitner](https://github.com/michaelzehetleitner) to make the extension more robust.
    
# Version 5.0.17
- 2026-03-25
- [#152](https://github.com/wjschne/apaquarto/issues/71) Fix .pdf longtable problem Thanks [drfurtado](https://github.com/drfurtado) for identifing the problem and [Michael Zehetleitner](https://github.com/michaelzehetleitner) posting a solution.
...
# Version 5.0.16
- 2026-03-25
- [#152](https://github.com/wjschne/apaquarto/issues/152) Fix .pdf journal mode line numbers Thanks [Ana Neves](https://github.com/AnafNeves)


# Version 5.0.15
- 2026-03-11
- [#150](https://github.com/wjschne/apaquarto/issues/150) Fix .pdf hanging indent for manuscript references. Thanks [Jillian Reynolds](https://github.com/jillianwreynolds)


# Version 5.0.14
- 2026-01-07
- [#149](https://github.com/wjschne/apaquarto/issues/149) Make source code single spaced. Thanks [jgeller112](https://github.com/jgeller112)!


# Version 5.0.13
- 2025-11-19
- [#143](https://github.com/wjschne/apaquarto/issues/143) Allow `fontsize` to be set for .pdf. Options are `10pt`, `11pt`, and `12pt`. Thanks [Matthew Warburton](https://github.com/mwarb) for bringing this to my attention.


# Version 5.0.12
- 2025-10-17
- [#139](https://github.com/wjschne/apaquarto/issues/139) Fixed `apa-note` problem with Typst. Thanks [lalamilalami](https://github.com/lalamilalami), [jgeller112](https://github.com/jgeller112), and  [RDutschke](https://github.com/RDutschke)!
- [#142](https://github.com/wjschne/apaquarto/issues/142) Fixed bug where `apa-note` was sometimes being incorrectly interpreted as a list instead of a paragraph. Thanks [RDutschke](https://github.com/RDutschke)!

# Version 5.0.11
- 2025-08-21
- Added support for the `note` field for pdf in `stu` mode. Thanks [choc96208](https://github.com/choc96208)!
...
# Version 5.0.7
- 2025-08-11
- [#137](https://github.com/wjschne/apaquarto/issues/137) Fixed error for when user does not supply a document mode for apaquarto-pdf documents. Thanks [Clemens Brunner](https://github.com/cbrnr)!
...
- 2025-08-02
- [136](https://github.com/wjschne/apaquarto/issues/136). Meta-analytic references incorrectly had asterisks if they were also cited in text. This problem is fixed. Also, if a reference header was omitted and there are references, one will added at the end. Thanks [lalamilalami](https://github.com/lalamilalami) for pointing out the problem!
...
- 2025-06-09
- [#28](https://github.com/wjschne/apaquarto/issues/28). Allow section numbering with Quarto's `number-section` (and `number-depth`) fields. Thanks [juho7](https://github.com/juho7) for the feature request and to [Ladislas Nalborczyk](https://github.com/lnalborczyk) for the solution to the longstanding problem.


# Version 5.0.2

- 2025-05-17
- [#130](https://github.com/wjschne/apaquarto/issues/130). Implement word count feature. Thanks [k-jens](https://github.com/k-jens)
...
- 2025-05-03
- [#128](https://github.com/wjschne/apaquarto/issues/128) Table and figure notes using `apa-note` now translate to the other languages in the .pdf format. Thanks [Guilherme Pinto](https://github.com/ggpinto)
